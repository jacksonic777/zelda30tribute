...
www/index.php
[2023.01.18]
・index.html を PHPに変更(index.php)
[2023.01.19]
・Shift-JISからUTF-8に変更、テスト。
...
//
$site_title = 'Zelda 30 Year Tribute';
$site_name  = 'Zelda 30 Year Tribute';
$site_url   = 'http://' . $_SERVER['HTTP_HOST'] . '/zel/zelda/www/';
$application_name = "Zelda Tribute";
$apple_mobile_web_app_title = 'Zelda Tribute';
$site_description =<<<EOM
A fan tribute to the greatest console game of all time, the NES Legend of Zelda.
This open source project uses WebGL and voxels rendering to create a pixel-perfect replica of the original, all in Javascript.
EOM;
//-------------------------------------------------------------------
//[スクリプトソース]
$src_vshader = "";//頂点シェーダー
$src_fshader = "";//フラグメントシェーダー
//
echo <<< EOM
<!DOCTYPE html>
...
<head>
    ...
    <link rel="icon" sizes="192x192" href="img/icon-mobile-192.png">
    <link rel="apple-touch-icon" href="img/icon-mobile.png">
    <link rel="apple-touch-icon" sizes="72x72" href="img/icon-mobile.png">
    <link rel="apple-touch-icon" sizes="114x114" href="img/icon-mobile.png">
    <link REL="apple-touch-icon" sizes="144x144" href="img/icon-mobile.png">
    ...
    <meta name="keywords" content="Legend of Zelda,Zelda,Tribute,30,Thirty,Voxel,WebGL" />
    <meta property="og:title" content="Zelda 30 Year Tribute" />
    <meta property="og:site_name" content="{$site_name}" />
    <meta property="og:description" content="{$site_description}" />
    <meta property="og:url" content="{$site_url}" />
    <meta property="og:image" content="{$site_url}img/logo-share.png" />
EOM;
...
//WebGL ピクセル単位の描画色を計算する「フラグメントシェーダー」
//<!-- WebGL ピクセル単位の描画色を計算する「フラグメントシェーダー」 -->
$src_fshader =<<< EOM
...
$src_js =<<< EOM
    ...
    <script type="text/javascript" src="js/ace.js.php"></script>
    <script type="text/javascript" src="js/game.js.php"></script>
...
<h2>GAME+SOUND+ART+MUSIC+
<br>MEMORIES+MAGIC</h2>
NINTENDO 
...
$src_about =<<< EOM
    ...
    <p>This site is a fan tribute to the greatest console game of all time.
    It was built by <a href="https://twitter.com/scottlininger" target="_blank">Scott</a>, a
    Colorado dad who works at
    <a href="https://bitsbox.com" target="_blank">Bitsbox</a> <a href="https://bitsbox.com" target="_blank" style="color:white;text-decoration:none">teaching
    kids to code</a>, and <a href="https://www.facebook.com/profile.php?id=100007287228430" target="_blank">Mike</a>, an independent mobile game developer and retro game enthusiast.
    ...
    <p><iframe src="about.html" width="400" height="100" frameborder="0"
      scrolling="no"
      marginheight="0"
      marginwidth="0">
...
<div id="hud-panel" class="hidden">
  ...
  <div id="hud-room"></div>
  <div id="hud-settings-panel">Thanks for playing! Please report bugs and stuff to:
  <a href="https://facebook.com/zelda30tribute" target="_blank">@zelda30tribute</a>
  <br>-Scott and Mike</div>
